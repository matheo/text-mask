...
```bash
npm i @myndmanagement/text-mask
```
...
**[this page](https://github.com/Mynd-Management/text-mask/blob/master/componentDocumentation.md#readme)**.
...
1. Clone the repo, `git clone git@github.com:Mynd-Management/text-mask.git`
1. `cd text-mask`
1. `cd angular2`
1. `npm install`
1. `npm start`
...
The code of the example is in [`angular2/example`](https://github.com/Mynd-Management/text-mask/tree/master/angular2/example).
